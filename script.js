document.addEventListener('DOMContentLoaded', () => {
  ...
  btnSim.addEventListener('click', irParaTela2);
  // touchend garante resposta imediata no celular (sem esperar o delay do click)
  btnSim.addEventListener('touchend', (e) => {
    e.preventDefault();
    irParaTela2();
  }, { passive: false });

  // ---------- BOTÃO NÃO (som triste ao "pegar" ele por acidente) ----------
